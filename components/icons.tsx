...
export const Icons = {
  ...
  divine: () => (
    <Image src="/images/divine.png" alt="Divine Orb" width={32} height={32} />
  ),
  chaos: () => (
    <Image src="/images/chaos.png" alt="Chaos Orb" width={32} height={32} />
  ),
  scarab: () => (
    <Image src="/images/scarab.png" alt="Scarab Icon" width={32} height={32} />
  ),
  delve: () => (
