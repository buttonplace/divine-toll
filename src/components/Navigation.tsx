...
const Navigation = () => {
  ...
  return (
    <Navbar className="bg-primary-800">
      <NavbarBrand>
        <Image
          src="/medbell.png"
        ...
        <Dropdown>
          ...
          >
            <DropdownItem
              key="scarab"
              startContent={
                <Image src="/scarab.png" alt="scarab" width={32} height={32} />
              }
            >
              Scarabs
            </DropdownItem>
            ...
            <DropdownItem
              key="fossil"
              startContent={
                <Image src="/fossil.png" alt="delve" width={32} height={32} />
              }
            >
              Delve
            </DropdownItem>
            <DropdownItem
              key="oil"
              startContent={
                <Image src="/oil.png" alt="oil" width={32} height={32} />
              }
            >
              Oils
            </DropdownItem>
