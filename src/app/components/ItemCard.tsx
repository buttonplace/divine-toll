      ...
      <Popover>
        <PopoverTrigger>
          <div
            ...
            className="col-span-2 m-1 h-[150px] cursor-pointer flex-col items-center justify-around overflow-auto rounded border-2 border-stone-900 bg-stone-600 selection:bg-none hover:bg-stone-500 hover:shadow-2xl hover:shadow-stone-800"
          >
