...
const INITIAL_VISIBLE_COLUMNS = ["name", "type", "listings"];

type Props ={
    itemsss: ItemWithPrices[],
}


// const ItemTable = ({type, itemsss}:Props) => {
const ItemTable = ({ itemsss}: Props) => {
  ...
  }, [itemsss, filterValue, statusFilter, hasSearchFilter]);
      ...
      case "type":
        return (
          <div className="flex flex-col">
            ...
            <p className="text-bold text-tiny capitalize text-default-400">{item.currentChaos.numerator}</p>
          </div>
        );
      case "listings":
        return (
          <Chip className="capitalize" color={statusColorMap["active"]} size="sm" variant="flat">
            {item.currentChaos.listingsUsed}
          </Chip>
        );
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Button color="primary" endContent={<SearchIcon />}>
              Add New
            </Button>
          </div>
        </div>
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">Total {itemsss.length} items</span>
